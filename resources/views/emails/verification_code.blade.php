    ...
    <div style="width:100%;padding:20px 0;display:-webkit-box;display:-ms-flexbox;display:flex;-ms-flex-wrap:wrap;flex-wrap:wrap;-webkit-box-align:center;-ms-flex-align:center;align-items:center;">
        <div style="width:600px;height:800px;margin:0 auto;background:#FFFFFF;padding:35px 35px;">
            <div style="margin-bottom:20px;">
                ...
                <div>
                    <p style="font-style:normal;font-weight:400;font-size:16px;line-height:24px;color:#212121;margin-bottom:10px;"><span style="color: #212121;">Hi, {{ $username }}</span><p>

                    <p style="font-style:normal;font-weight:400;font-size:16px;line-height:24px;color:#212121;margin-bottom:10px;"><span style="color: #212121;">As a part of our security protocol, we have generated a <b>One-Time Password(OTP)</b> for your login.</span><p>

                        <p style="font-style:normal;font-weight:400;font-size:16px;line-height:24px;color:#212121;margin-bottom:15px;">Please use the following <i><b>OTP code</b></i> to authenticate and access the account. </p>

                    <div style="text-align:center;line-height:3.5;padding:12px;gap:10px;height:50px;background:#2D66F5;border-radius:2px;">
                    ...
                    <div style="display:flex;flex-direction:row;align-items:center;align-items:flex-start;margin-top:15px;">
                    ...
                    <div style="width:241px;height:10px;margin:0 auto;">
            ...
            <div style="border-top:1px solid #F1F1F1;">
                <p style="width:216px;height:17px;font-style:italic;font-weight:400;font-size:14px;line-height:17px;text-align:center;color:#ADADAD;margin-top:10px">Please do not reply to this email.</p>
            </div>
            <div>
                <div style="max-width:370px;margin:0 auto;width:95%;margin-bottom:10px;">
                ...
                <div style="margin-top:10px">
                    <p style="font-style:normal;font-weight:300;font-size:12px;line-height:10px;text-align:center;color:#212121;">+977-015971473</p>
                </div>
                ...
                <div style="text-align:center;margin-top:10px;" class="socials">
